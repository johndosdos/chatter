...
Load these global skills when relevant:

| Skill      | When to load                                                |
| ---------- | ----------------------------------------------------------- |
| `security` | Auth, data access, user-facing endpoints, pre-deploy review |
| `database` | Writing queries, configuring the pool, migrations           |
